        ...
        <tbody>
          <tr v-for="project in this.projects" :key="project.id">
            ...
            <td class="d-flex">
              ...
              <button @click="() => { this.toRemove.id = project.id; this.toRemove.name = project.name }"
                class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" id="delete">Delete</button>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-success" @click="() => handleRemove()" data-bs-dismiss="modal">Remove
              it</button>
...
export default {
  ...
  methods: {
    ...mapActions(useProjectStore, ['getAllProjects', 'removeProject']),
    handleRemove() {
      this.removeProject();
    }
  },
